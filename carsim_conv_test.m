...
elseif strcmp(MAmode, 'kinematic');
    MAkf.P = diag(100*[vbf.stdmis, vbf.stdlo, vbf.stdmis].^2);
    MAkf.Q = diag(10*[vbf.stdmis, vbf.stdlo, vbf.stdkin].^2);
    MAkf.R = diag(1*[20*vbf.stdnhc, 10*vbf.stdnhc, 1*vbf.stdkin].^2);
